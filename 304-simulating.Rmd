...
author: "Liu Yijia, Jiayi Yu, Ziyue Yang and Boyu Cao"
...
## Results
  ...
  Among the 500 questionnaires we sampled, the number of people who voted for the Liberal Party in the last poll accounted for a maximum of 40%. It was followed by the Conservative Party with 32% of the vote. The NDP and the Green Party received 16% and 9% support respectively (Figure 1). However, in the forecast for a new vote, the number of people willing to vote for the Liberal Party soared to 47% (Figure 3). It also shows that the masses are dissatisfied with the performance of the Conservative Party in Ontario. Statistics confirmed this feedback. 55% of the people expressed dissatisfaction with the current government (Figure 2).
...
political_leaning <- tibble(last_vote = sample(x=last_vote, size=n, replace=TRUE, prob=c(0.386, 0.323, 0.184, 0.073, 0.035)),
